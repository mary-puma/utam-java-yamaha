...
public class LeadRepuesto extends SalesforceWebTestBase{
    ...
    @Test(description = "Creacion de un Lead: Verificar que aparesca el mensaje de error cuando el campo sea requerido" +
            "Pasos: Crear un lead de tipo Repuesto sin completar ningun campo, para verificar los menajes de validacion")
    public void validationOfRequiredFields() {
        ...
        Assert.assertEquals(copiaRecordActionWrapper.getDesktopRecordPageDecorator().getTitle().getText(),"Crear Candidato: Repuesto");
        ...
        for (int i = 0; i < 30; i++) {
            ...
            //input con el componente record-layout-base-input
